...
namespace DhanMarketData.Persistence.Migrations
{
    ...
    [Migration("20260523072327_SeedEmaPullbackPreset")]
    partial class SeedEmaPullbackPreset
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DhanMarketData.Persistence.Entities.StrategyPreset", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "9/20 EMA stacked + rising 20 EMA; pullback touches 9 EMA with a bullish close inside the morning (09:30-11:00) or early-afternoon (13:30-14:45) window. Enter next bar's open, SL at trigger low, 1.5R target, hard exit 15:00 IST.",
                            IsBuiltIn = true,
